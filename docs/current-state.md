...
- `PRODUCT.md` and `DESIGN.md` provide repo-local product and design context for future UI work.
- `Stash/Design/SugarbuzzTheme.swift` mirrors the Sugarbuzz `theme-stash` palette: terracotta primary accent, deep-teal support accent, and warm-stone neutrals.
